...
# ==========================================
# 1. IDENTIDAD DE LA CUENTA (EXNESS #1)
# ==========================================
NOMBRE_CUENTA = "Exness #1"
NUMERO_PRUEBA = 1

BROKER_PATH = r"C:\Users\vr4ux23\Documents\Bot_Trading_exness\terminal64.exe"
MODELO_PATH = r"C:\Users\vr4ux23\Documents\Bot_Trading_exness\modelo_rf_eurusd.pkl"
BROKER_SERVIDOR = "Exness-MT5Trial12"

# CREDENCIALES DESDE .ENV
LOGIN_CUENTA = int(os.getenv("EXNESS_LOGIN"))
PASSWORD_CUENTA = os.getenv("EXNESS_PASSWORD")
