...
# Cargar las credenciales ocultas del archivo .env
load_dotenv()

# ==========================================
# 1. IDENTIDAD DE LA CUENTA (ALPHA CAPITAL 1)
# ==========================================
NOMBRE_CUENTA = "Alpha Capital 1"
NUMERO_PRUEBA = 1

# Rutas protegidas (Raw Strings para Windows)
BROKER_PATH = r"C:\Users\vr4ux23\Documents\Bot_Trading_Alpha\terminal64.exe"
MODELO_PATH = r"C:\Users\vr4ux23\Documents\Bot_Trading_Alpha\modelo_rf_eurusd.pkl"
BROKER_SERVIDOR = "ACGMarkets-Main"

# ==========================================
# 🔐 CREDENCIALES SEGURAS EXTRAÍDAS DEL .ENV
# ==========================================
LOGIN_CUENTA = int(os.getenv("ALPHA_LOGIN"))
PASSWORD_CUENTA = os.getenv("ALPHA_PASSWORD")
...
def verificar_cierre_posicion():
    ...
    if posicion is None or len(posicion) == 0:
        ...
        if deals:
            ...
            trades_hoy += 1
            # Corrección anti-errores (división por cero)
