...
# ==========================================
# 1. IDENTIDAD DE LA CUENTA (AUDACITY CAPITAL #1)
# ==========================================
NOMBRE_CUENTA = "Audacity Capital #1"
NUMERO_PRUEBA = 1

BROKER_PATH = r"C:\Users\vr4ux23\Documents\Bot_Trading_Audacity\terminal64.exe"
MODELO_PATH = r"C:\Users\vr4ux23\Documents\Bot_Trading_Audacity\modelo_rf_eurusd.pkl"
BROKER_SERVIDOR = "AudaCityGlobal-Live"

# CREDENCIALES DESDE .ENV
LOGIN_CUENTA = int(os.getenv("AUDACITY_LOGIN"))
PASSWORD_CUENTA = os.getenv("AUDACITY_PASSWORD")
